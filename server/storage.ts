    ...
    const services: Service[] = [
      {
        ...
        basicDeliverables: [
          "1 dedicated promotional tweet",
          "Basic engagement (likes, retweets)",
          "Tag your project in 1 thread",
          "24-hour campaign duration"
        ],
        standardDeliverables: [
          "3 promotional tweets over 3 days",
          "1 detailed Twitter thread (8-10 tweets)",
          "10+ retweets from engaged followers",
          "Reply to top comments on your posts",
          "Pin tweet for 48 hours",
          "Story mentions on 2 platforms"
        ],
        premiumDeliverables: [
          "7-day comprehensive campaign",
          "5+ promotional tweets with strategic timing",
          "3 detailed Twitter threads",
          "30+ retweets and quote tweets",
          "Active reply engagement (50+ replies)",
          "Cross-platform promotion (Telegram, Discord)",
          "Pinned tweet for full week",
          "Weekly performance report with metrics"
        ],
      ...
      },
      {
        ...
        description: "Full-service Twitter management for your project. Daily posts, engagement, reply buying, following lists, and growth strategies to build your community.",
        category: "Marketing & Growth",
        deliveryTime: "30 days",
        basicPrice: "1500",
        standardPrice: "3500",
        premiumPrice: "8000",
        basicDescription: "Daily posting and basic engagement",
        standardDescription: "Daily management with reply buying and growth tactics",
        premiumDescription: "24/7 comprehensive management with full engagement suite",
        basicDeliverables: [
          "5 tweets per day (content creation included)",
          "Basic reply engagement (20 replies/day)",
          "1 curated following list per week",
          "Daily activity monitoring",
          "Weekend coverage"
        ],
        standardDeliverables: [
          "10 tweets per day (mixed content types)",
          "Reply buying service (50 quality replies/day)",
          "Active engagement on 30+ target accounts",
          "3 curated following lists per week",
          "Custom hashtag strategy",
          "Competitor monitoring",
          "Weekly growth report",
          "Community management (respond to DMs)"
        ],
        premiumDeliverables: [
          "15+ tweets per day (optimized posting schedule)",
          "Premium reply buying (100+ high-quality replies/day)",
          "Aggressive engagement farming (50+ accounts/day)",
          "Daily curated following lists with growth analysis",
          "Twitter Spaces participation and hosting",
          "Trend jacking and viral content creation",
        ...
        tags: ["Twitter Management", "Social Media", "Reply Buying", "Following Lists", "Community Growth", "Daily Posting"],
        psxRequired: "7000",
        featured: true,
        portfolioMedia: ["https://images.unsplash.com/photo-1611926653670-e2c1d9e03d2c?w=800&q=80"],
        videoUrls: null,
      },
    ];
