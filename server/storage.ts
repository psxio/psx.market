...
export class PostgresStorage implements IStorage {
  ...
  async approveBuilderApplication(id: string): Promise<Builder> {
    ...
    const builder = await this.createBuilder({
      ...
      headline: application.headline || `${application.category} Expert`,
      bio: application.bio,
      ...
      editingSoftware: application.editingSoftware,
      editingSpecialties: application.editingSpecialties,
      videoTypes: application.videoTypes,
      portfolioReel: application.portfolioReel,
      platformsManaged: application.platformsManaged,
      maxCommunitySize: application.maxCommunitySize,
      moderationTools: application.moderationTools,
      raidCoordination: application.raidCoordination,
      timezoneAvailability: application.timezoneAvailability,
